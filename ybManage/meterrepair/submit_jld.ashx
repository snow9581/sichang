...
public class submit_jld : BaseHandler {
    ...
    override public void AjaxProcess (HttpContext context) {
     ...
     //   string sql = "update T_METER_REPAIR set WXDW='" + strs[0] + "',WXNR='" + strs[1] + "',PJYYQK='" + strs[2] + "',WXJG='" + strs[3] + "',WXRQZ='" + strs[4] + "',STATE='4',SCDWQZ='" + strs[5] + "' where ID=" + strs[6];
        //将原来固定拼接update SQL语句改为根据传参的情况动态拼接。

        string sql = "update T_METER_REPAIR set STATE='6', ";//在状态3与4之间增加一个状态6，代表维修人已维修完毕，并填写完维
