<%@ Page Language="C#" AutoEventWireup="true" CodeFile="show_meter_repair.aspx.cs" Inherits="ybManage_meterrepair_show_meter_repair" %>
    ...
    <table id="dg" width="100%">
        <thead>
            <tr>
				...
				<th field="DW">申请单位</th>				
				<th field="YQYBMC" width="30">器具名称</th>
                <th field="GGXH" width="30">规格型号</th>
				<th field="AZWZ" width="30">安装位置</th>
