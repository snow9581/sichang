<%@ Page Language="C#" AutoEventWireup="true" CodeFile="input_waterWell.aspx.cs" Inherits="crud_form_input_waterWell" %>
...
<body>
	...
	<table class="dv-table" style="width:100%;background:#fafafa;padding:5px;margin-top:5px;">
		<tr> 
			...
			<td>注水站名称</td>
			<td><input name="ZSZMC" class="easyui-validatebox" /></td>
			<td>井号</td>
		...
		<tr> 
			...
			<td><input name="TCRQ" class="easyui-datebox" /></td>
             <td>配水间名称</td>
			<td><input name="PSJMC" class="easyui-validatebox" /></td>
        </tr>
		<tr>       
            <td>干线名称</td>
			<td><input name="GXMC" class="easyui-validatebox" /></td>
            <td>地类</td>
			<td><input name="LANDTYPE" class="easyui-validatebox" /></td>
        </tr>
		<tr>
            <td>是否有根部阀</td>
			<td><input name="GBF" class="easyui-validatebox" /></td>
            <td>根部阀规格</td>
			<td><input name="GBFFORMAT" class="easyui-validatebox" /></td>
		    <td>备注</td>
