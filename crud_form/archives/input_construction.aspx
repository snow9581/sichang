<%@ Page Language="C#" AutoEventWireup="true" CodeFile="input_construction.aspx.cs" Inherits="easyui_crud_demo_show_form" %>
...
<body>
	...
	<table class="dv-table" style="width:100%;background:#fafafa;padding:5px;margin-top:5px;">
		...
		<tr>
            ...
            <td>蓝图下发时间</td>
			<td><input name="ARRIVALDATE" id="ARRIVALDATE" class="easyui-datebox" /></td>			
		</tr>
        </table>
