<%@ Page Language="C#" AutoEventWireup="true" CodeFile="input_InstructionDocuments.aspx.cs" Inherits="crud_form_archives_input_InstructionDocuments" %>
...
<body>
	...
	<table class="dv-table" style="width:100%;background:#fafafa;padding:5px;margin-top:5px;">
		<tr>
            ...
            <td>请示部门</td>
			<td><input name="QSBM" class="easyui-validatebox" data-options="validType:'CHS'"/></td>
