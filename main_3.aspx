<%@ Page Language="C#" AutoEventWireup="true" CodeFile="main_3.aspx.cs" Inherits="main" %>
<!--矿工艺队操作界面-->
...
<body class="easyui-layout">
    <div region="west" title="功能模块" style="width: 200px;" split="true">
        <div class="easyui-accordion" style="width: 198px; height: 460px;">
            <div title="地面档案管理" iconcls="icon-T_DMDA" style="overflow: auto;display:none;" selected="false">
                <ul>
            ...
            <div title="资料提交系统" iconcls="icon-T_ZLTJ" style="overflow: auto;" selected="true">
                <ul>
                    <li style="list-style-type: none; line-height: 1.8;"><a href="#" style="cursor: pointer;
                    text-decoration: none;" onclick="addTab('查看调查','datasubmit/minerSurveyMain.aspx')">分派待处理调查</a> </li>
                     <li style="list-style-type: none; line-height: 1.8;"><a href="#" style="cursor: pointer;
                    text-decoration: none;" onclick="addTab('调查审核','datasubmit/minerTeamCheckMain.aspx')">审核小队提交调查</a> </li>
                    <li style="list-style-type: none; line-height: 1.8;"><a href="#" style="cursor: pointer;
                    text-decoration: none;" onclick="addTab('提交资料','datasubmit/minerTeamSubmitMain.aspx')">提交调查至矿长</a> </li>
                    <li style="list-style-type: none; line-height: 1.8;"><a href="#" style="cursor: pointer;
                    text-decoration: none;" onclick="addTab('提交资料','datasubmit/minerCheckReturnMain.aspx')">矿长驳回调查资料</a> </li>                   
                    <li style="list-style-type: none; line-height: 1.8;"><a href="#" style="cursor: pointer;
                    text-decoration: none;" onclick="addTab('历史调查记录','datasubmit/viewHistorySurvey_KGYD.aspx')">查看历史调查记录</a> </li>
                  
                </ul>
            </div>
             <div title="进度计划运行表" iconcls="icon-ok" style="overflow: auto;">
                <ul>
                    <li style="list-style-type: none; line-height: 1.8;"><a href="#" style="cursor: pointer;
                    text-decoration: none;" onclick="addTab('工程量信息','plan/planRun_dtz/AssignmentWorkload_mine.aspx')">工程量信息</a> </li>
                </ul>
            </div>
