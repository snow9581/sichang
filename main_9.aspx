<%@ Page Language="C#" AutoEventWireup="true" CodeFile="main_9.aspx.cs" Inherits="main" %>
<!--矿计量员操作界面-->
            ...
            <div id="div2" title="仪表管理" iconcls="icon-ok" style="overflow: auto;"  >
                <ul>
                    ...
                    <li style="list-style-type: none; line-height: 1.8;"><a id="a3" runat="server" href="#" style="cursor: pointer;
                        text-decoration: none;" onclick="addTab('现场故障维修','ybManage/meterrepair/show_meter_repair.aspx')">故障维修</a> </li>
