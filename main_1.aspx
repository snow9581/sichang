<%@ Page Language="C#" AutoEventWireup="true" CodeFile="main_1.aspx.cs" Inherits="main_1" %>
<!--小队主操作界面-->
    ...
    <div region="west" title="功能模块" style="width: 200px;" split="true">
        <div class="easyui-accordion" style="width: 198px; height: 460px;">
            ...
            <div title="资料提交系统" iconcls="icon-T_ZLTJ" style="overflow: auto;" selected="false">
                <ul>                   
                   <li style="list-style-type: none; line-height: 1.8;"><a href="#" style="cursor: pointer;
                        text-decoration: none;" onclick="addTab('待填写调查报告','datasubmit/teamSubmitMain.aspx')">待填写调查报告</a> </li>
                   <li style="list-style-type: none; line-height: 1.8;"><a href="#" style="cursor: pointer;
                        text-decoration: none;" onclick="addTab('已填写调查报告','datasubmit/teamSubmitView.aspx')">已填写调查报告</a> </li>
                         <li style="list-style-type: none; line-height: 1.8;"><a href="#" style="cursor: pointer;
                        text-decoration: none;" onclick="addTab('被返回调查报告','datasubmit/teamSubmitReturn.aspx')">被返回调查报告</a> </li>                       
                    <li style="list-style-type: none; line-height: 1.8;"><a href="#" style="cursor: pointer;
                    text-decoration: none;" onclick="addTab('历史调查记录','datasubmit/viewHistorySurvey_XD.aspx')">历史调查记录</a> </li>
                </ul>
            </div>
            <div id="div2" title="仪表管理" iconcls="icon-ok" style="overflow: auto;"  >
             ...
             <div title="进度计划运行表" iconcls="icon-ok" style="overflow: auto;">
                <ul>
                    <li style="list-style-type: none; line-height: 1.8;"><a href="#" style="cursor: pointer;
                    text-decoration: none;" onclick="addTab('工程量信息','plan/planRun_dtz/AssignmentWorkload_team.aspx')">工程量信息</a> </li>
                </ul>
            </div>
