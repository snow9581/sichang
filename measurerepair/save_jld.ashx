...
public class save_jld : BaseHandler {
    ...
    override public void AjaxProcess (HttpContext context) {
        ...
        //string sql = "update T_measure_REPAIR set WXDW='" + strs[0] + "',WXNR='" + strs[1] + "',PJYYQK='" + strs[2] + "',WXJG='" + strs[3] + "',WXRQZ='" + strs[4] + "',SCDWQZ='" + strs[5] + "' where ID=" + strs[6];
        
        //将原来固定拼接update SQL语句改为根据传参的情况动态拼接。
        
        string sql = "update T_measure_REPAIR set";
