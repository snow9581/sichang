...
/// <summary>
/// DB 的摘要说明              **直接利用.NET的oracle驱动连接** 
/// connStr = @"Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.1.100)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=ORCL1)));User Id=system;Password=a123";
