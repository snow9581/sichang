<%@ Page Language="C#" AutoEventWireup="true" CodeFile="main_4.aspx.cs" Inherits="main" %>
<!--主管所长主操作界面-->
...
<form id="form1" method="post" action="plan/ReloadMain.ashx">
    <div region="west" title="功能模块" style="width: 200px;" split="true">
        <div id="divTree" style="width: 198px; height: 460px;">
					    ...
					    <li style="list-style-type:square;line-height: 1.8;">
                         ...
                         <li style="list-style-type:square;line-height: 1.8;">
						    <a id="A5" runat="server" href="#" style="cursor: pointer;
                                text-decoration: none;" onclick="addTab('自主设计->进度计划','plan/planRun_dtz/show_planRun_suozhang.aspx')">进度计划</a>
					    </li>
                    </ul>
                    </li>
