<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teamSubmitReturn.aspx.cs" Inherits="datasubmit_teamSubmitReturn" %>
    ...
    <script src="../js/datagrid-detailview.js" type="text/javascript"></script>
       ...
       <script type="text/javascript">
           ...
           function goById(id) {
               ...
               document.getElementById("fcheck").src = "teamSubmit2.aspx?id=" + id;
           }
