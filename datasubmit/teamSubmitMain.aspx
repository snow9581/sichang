<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teamSubmitMain.aspx.cs" Inherits="datasubmit_teamSubmitMain" %>
    ...
    <script src="../js/datagrid-detailview.js" type="text/javascript"></script>
       ...
       <script type="text/javascript">
           ...
           function goById(id) {
               ...
               document.getElementById("fcheck").src = "teamSubmit.aspx?id=" + id;
           }
