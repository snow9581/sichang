<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teamSubmit2.aspx.cs" Inherits="datasubmit_teamSubmit2" %>
...
<td  style="width:80%"><input  id="NAME"  style="width:100%" readonly="readonly"
        runat="server" class="easyui-textbox"/></td>                
<td  style="width:80%">&nbsp;</td>                
</tr>      

<tr>                    
<td><div id="RT" runat="server">调查要求</div></td>                    
<td><textarea  id="REQUIREMENTS" readonly="readonly" rows="5" cols="30" runat="server" /></td>
</tr>  
          
<tr>                    
<td style="width:25%">调查表Word:</td>                    
<td  style="width:80%">
...
<tr>                    
<td>审批意见：</td>                   
<td><textarea  id="SHYJ" rows="5" cols="30" runat="server"  readonly="readonly" /></td>                
<td>&nbsp;</td>                
</tr>                
