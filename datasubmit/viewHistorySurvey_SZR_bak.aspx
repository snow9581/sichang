...
<head runat="server">
  ...
  <script type="text/javascript">
        ...
        $(function() {
            $('#dg').datagrid({
                title: "查看历史调查记录",
                url: "./viewHistorySurvey_SZR.ashx",
                fit: true,
                fitColumns: true,
                showFooters: true,
                collapsible: true,
                ...
                onLoadSuccess: function(data) {
                    if (data.rows.length > 0) {
                        ...
                        GMergeCells("dg", "INITDATE,MINERNAME,EXCELNAME0");                        
                    }
                },
                loader: SCLoader  
            });
        ...
        */
        ...
        function goExcel(val, row) {
           ...
           if((val!='#')&&(val!='')) return '<a href="downloadPic.aspx?picName=' + escape(row.EXCELNAME) + '&package=materialsubmit" target="_blank">' + row.EXCELNAME + '</a>  '
        ...
        function goExcel0(val, row) {
            ...
            if((val!='#')&&(val!='')) return '<a href="downloadPic.aspx?picName=' + escape(row.EXCELNAME0) + '&package=materialsubmit" target="_blank">' + row.EXCELNAME0 + '</a>  '
