<%@ Page Language="C#" AutoEventWireup="true" CodeFile="initSurveyReturnMain.aspx.cs" Inherits="datasubmit_initSurveyReturnMain" %>
    ...
    <script src="../js/datagrid-detailview.js" type="text/javascript"></script>
       ...
       <script type="text/javascript">
           ...
           function goById(id) {
               ...
               document.getElementById("fcheck").src = "initSurveyReturn.aspx?id=" + id;
           }
