...
//
public partial class crud_tables_downloadPic : BasePage
{
    ...
    public void FTPDirectDownloadFile(string ftpServerIP, string ftpUserID, string ftpPassword,string downloadFileName)
    {
       ...
       // SClog.insert("DEBUG", "FTPDirectDownloadFile");
        try
        {
            //生成FTP请求对象
         ...
         //   SClog.insert("DEBUG", "ftp://" + ftpServerIP + "/" + downloadFileName);
