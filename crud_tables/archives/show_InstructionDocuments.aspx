<%@ Page Language="C#" AutoEventWireup="true" CodeFile="show_InstructionDocuments.aspx.cs" Inherits="crud_tables_archives_show_InstructionDocuments" %>
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
      ...
      $(function () {
          $('#dg').datagrid({
              title: "请示文档",
              url: "../../crud_get/archives/get_InstructionDocuments.ashx",
              fit: true,
              fitColumns: true,
              showFooters: true,
              collapsible: true,
              ...
              onExpandRow: function (index, row) {
                  ...
                  ddv.panel({
                      border: false,
                      cache: true,
                      href: '../../crud_form/archives/input_InstructionDocuments.aspx?index=' + index,
                      onLoad: function () {
      ...
      function saveItem(index) {
          ...
          //alert(row.ID);
          var url = row.isNewRecord ? '../../crud_insert/archives/insert_InstructionDocuments.ashx' : '../../crud_update/archives/update_InstructionDocuments.ashx?ID=' + row.FID;
          //alert(url);
              ...
              $.messager.confirm('confirm', 'are you sure to delete this data?', function (r) {
                  if (r) {
                      for (var i = rows.length - 1; i >= 0; i--) {
                          //alert(rows[i].FID);
                          $.post('../../crud_destroy/archives/destroy_InstructionDocuments.ashx', { ID: rows[i].FID });
                      }
      ...
      function Save_Excel() {
          ...
          window.location = "../../tools/toExcel.aspx?name=名称,请示部门,上传日期" +
            " &field=FNAME,QSBM,SCRQ&location=T_InstructionDocuments&condition=" + escape(conditions);
     ...
     <table id="dg">
        <thead>
            <tr>
                ...
                <th field="QSBM" width="50" sortable="true">请示部门</th>
