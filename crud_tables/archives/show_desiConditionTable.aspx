<%@ Page Language="C#" AutoEventWireup="true" CodeFile="show_desiConditionTable.aspx.cs" Inherits="crud_tables_archives_show_desiConditionTable" %>
...
<script type="text/javascript">
    ///<summary> 
    ///模块编号：archives-01 电子档案管理子系统1号模块 方案文档表 table功能代码   
  ...
  <script type="text/javascript">
      ...
      $(function () {
          $('#dg').datagrid({
              title: "设计条件表",
              url: "../../crud_get/archives/get_desiConditionTable.ashx?pna=" + encodeURIComponent($('#HDpname').val()) + "&pnum=" + encodeURIComponent($('#HDpnumber').val()),
              fit: true,
              fitColumns: true,
              showFooters: true,
              collapsible: true,
              ...
              onExpandRow: function (index, row) {
                  ...
                  ddv.panel({
                      border: false,
                      cache: true,
                      href: '../../crud_form/archives/input_desiConditionTable.aspx?index=' + index,
                      onLoad: function () {
      ...
      function saveItem(index) {
          ...
          //alert(row.ID);
          var url = row.isNewRecord ? '../../crud_insert/archives/insert_desiConditionTable.ashx' : '../../crud_update/archives/update_desiConditionTable.ashx?ID=' + row.ID;
          //alert(url);
              ...
              $.messager.confirm('提示', '你确定要删除已选记录吗?', function (r) {
                  if (r) {
                      for (var i = rows.length - 1; i >= 0; i--)
                          $.post('../../crud_destroy/archives/destroy_desiConditionTable.ashx', { ID: rows[i].ID });
      ...
      function Save_Excel() {
          ...
          window.location = "../../tools/toExcel.aspx?name=项目编号,项目名称,编写时间,项目负责人,项目投资,主要工程量,关键字,投资类型,审核人,备注" +
            " &field=PID,PNAME,BXRQ,PLEADER,PMONEY,MAINWORK,KWORDS,INVESTTYPE,REVIEWER,BZ&location=T_DESICONDITIONTABLE&condition=" + escape(conditions);
...
<body>
     <table id="dg">
        <thead>
            <tr>
				...
				<th field="BXRQ" class="style1" width="80" sortable="true">编写时间</th>
				<th field="PLEADER" class="style2">项目负责人</th>
				<th field="PMONEY"  width="50" sortable="true">项目投资</th>
				<th field="MAINWORK" width="50" class="style3" sortable="true">主要工程量</th>
				<th field="KWORDS"  width="50"sortable="true">关键字</th>
				<th field="INVESTTYPE"   width="50" sortable="true">投资类型</th>
				<th field="REVIEWER"  width="50" >审核人</th>
				<th field="BZ"  width="50" >备注</th>
				<th data-options="field:'FILES',formatter:go"  width="50">设计条件表</th>					
			</tr>
        </thead>
    </table>
    ...
    <div id="toolbar">
        ...
        <span>方案编写时间:</span><input name="KSRQ" id="KSRQ" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" />
