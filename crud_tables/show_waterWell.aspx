<%@ Page Language="C#" AutoEventWireup="true" CodeFile="show_waterWell.aspx.cs" Inherits="crud_tables_show_waterWell" %>
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
        $(function () {
            $('#dg').datagrid({
                title: "水井",
                url: "../crud_get/get_waterWell.ashx",
                fit: true,
                fitColumns: false,
                showFooters: true,
                collapsible: true,
                ...
                onExpandRow: function (index, row) {
                    ...
                    ddv.panel({
                        border: false,
                        cache: true,
                        href: '../crud_form/input_waterWell.aspx?index=' + index + '&id=' + id,
                        onLoad: function () {
        ...
        function saveItem(index) {
            ...
            var url = row.isNewRecord ? '../crud_insert/insert_waterWell.ashx' : '../crud_update/update_waterWell.ashx?ID=' + row.ID;
                ...
                $.messager.confirm('提示', '你确定要删除已选记录吗?', function (r) {
                    if (r) {
                        for (var i = rows.length - 1; i >= 0; i--)
                            $.post('../crud_destroy/destroy_waterWell.ashx', { id: rows[i].ID });
        ...
        function Save_Excel() {
            ...
            window.location = "../tools/toExcel.aspx?name=矿名,队名,所属站名,注水站名称,井号,投产日期,管线规格,长度,配水间名称,干线名称,地类,是否有根部阀,根部阀规格,备注" +
            " &field=KM,DM,ZM,ZSZMC,WNUMBER,TCRQ,GXGG,LENGTH,PSJMC,GXMC,LANDTYPE,GBF,GBFFORMAT,BZ&location=T_waterWell&condition=" + escape(conditions);
  ...
  <table id="dg">
        <thead>         
            <tr>
				...
				<th field="ZSZMC"  width="150" sortable="true">注水站名称</th>
				...
				<th field="PSJMC"  width="150">配水间名称</th>
				<th field="GXMC"  width="150">干线名称</th>
				<th field="LANDTYPE" width="100">地类</th>
				<th field="GBF" width="100">是否有根部阀</th>
                <th field="GBFFORMAT" width="100">根部阀规格</th>
    ...
    <div id="toolbar">
        ...
        <span><label for="ZSZMC">注水站名称:</label></span><input class="easyui-textbox" id="ZSZMC" value="" size=10 />
        ...
        <a href="../File/WATERWELL.xls" class="easyui-linkbutton" iconCls='icon-download'">下载模板</a>
