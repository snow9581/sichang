<%@ Page Language="C#" AutoEventWireup="true" CodeFile="show_planRun_sj.aspx.cs" Inherits="plan_planRun_dtz_show_planRun_sj" %>
...
<link href="../../themes/default/easyui.css" rel="stylesheet" type="text/css"/>
 ...
 <script type="text/javascript">
     $(function () {
         $('#dg').datagrid({
             title: "自主设计->设计阶段",
             url: "get_planRun_dtz.ashx?buf=0&type=sj",
             fit: true,
             fitColumns: false,
             showFooters: true,
             collapsible: true,
     ...
     function Save_Excel() {
         ...
         if ($('#DESICHIEF').val() != '')
             conditions += " and DESICHIEF like '%" + $('#DESICHIEF').val() + "%'";

         conditions += " and DESICHIEF IS NOT NULL and BLUEGRAPHARRIVALDATE IS NULL";

         window.location = "../../tools/toExcel.aspx?name=项目名称,项目来源,项目设计负责人,主专业校对及室负责人,概算汇总人,一次委托资料计划时间,一次委托资料实际时间,工程量计划提交时间,工程量实际提交时间,概算计划完成时间,概算实际完成时间,初设计划上报时间,初设实际上报时间,概算计划调整时间,概算实际调整时间,计划下达文件号,计划下达文件批准日期,设计批复下达文件号,设计批复文件批准日期,二次委托资料结束时间,施工白图计划校审时间,施工白图实际校审时间,蓝图计划存档时间,蓝图实际存档时间,蓝图下发时间,备注,发起时间" +
            "&field=PNAME,PSOURCE,DESICHIEF,MAJORPROOFREADER,BUDGETCHIEF,MAJORDELEGATEDATE_P,MAJORDELEGATEDATE_R,WORKLOADSUBMITDATE_P,WORKLOADSUBMITDATE_R,BUDGETCOMPDATE_P,BUDGETCOMPDATE_P,INITIALDESISUBMITDATE_P,INITIALDESISUBMITDATE_R,BUDGETADJUSTDATE_P,BUDGETADJUSTDATE_R,PLANARRIVALFILENUMBER,PLANARRIVALDATE,DESIAPPROVALARRIVALFILENUMBER,DESIAPPROVALARRIVALDATE,SECONDCOMMISSIONDATE,WHITEGRAPHCHECKDATE_P,WHITEGRAPHCHECKDATE_R,BLUEGRAPHDOCUMENT_P,BLUEGRAPHDOCUMENT_R,BLUEGRAPHARRIVALDATE,REMARK,INITDATE&location=T_PLANRUN_DTZ&condition=" + escape(conditions) ;
...
<div data-options="region:'center',split:true">
  <table id="dg"  style="width:100%; height:100%">
    ...
    <div id="toolbar">  
        ...
        <span><label for="DESICHIEF">项目设计负责人:</label></span><input class="easyui-textbox" id="DESICHIEF" value="" size="10" /> 
