    ...
    <table id="dg">
        <thead>
            <tr>		
                ...
                <th field="TEMPNAME" sortable="true" data-options="width:180">模板名称</th>
                <th field="INITDESICYCLE" sortable="true" data-options="width:180">初设上报周期</th>
				<th field="BUDGETCYCLE"  sortable="true" data-options="width:180">概算周期</th>
				<th field="BUDGETADJUSTCYCLE" sortable="true" data-options="width:180">概算调整周期</th>				
			</tr>
        </thead>
    </table>
