...
<body>
	...
	<table class="dv-table" style="width:100%;background:#fafafa;padding:5px;margin-top:5px;">
		<tr>
            ...
            <td>初设周期</td>
			<td><input name="INITDESICYCLE" class="easyui-validatebox" size='5' value='0' /></td>
			<td>概算周期</td>
			<td><input name="BUDGETCYCLE" class="easyui-validatebox" size='5' value='0'/></td>
			<td>概算调整周期</td>
			<td><input name="BUDGETADJUSTCYCLE" class="easyui-validatebox" size='5' value='0'/></td>		
		</tr>
        </table>
