<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ghs2_Datasubmit.aspx.cs" Inherits="plan_planRun_bdtz_ghs2_Datasubmit" %>
...
<body>
<div id="p" class="easyui-panel" title="上传所审通过方案" style="width:100%;padding:10px;">
  <div style="padding:10px 40px 20px 40px">  
    <form id="ff" method="post" action="ghs2_Datasubmit.ashx" enctype="multipart/form-data">
   <input value="1" type="hidden" id="hd_id"  runat="server"/>
	<table id="Table1" class="dv-table" style="width:100%; margin-top :5px; text-align:center" cellpadding="5">
		...
		<tr>
			...
			<td><input  type="hidden" id="WorkloadFile"  runat="server"/> </td>
			<td>所审通过方案</td>
			<td><input type="file"  id="APPRSOLUTIONFILE" name="APPRSOLUTIONFILE" class="easyui-validatebox textbox" runat="server" data-options="required:true"/></td>
