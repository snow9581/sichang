<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DesignGraphDate.aspx.cs" Inherits="plan_planrun_bdtz_DesignGraphDate" %>
...
<body>
 <div id="p" class="easyui-panel" title="上传初设和蓝图时间" style="width:100%;padding:10px;" >
 <div style="padding:10px 30px 20px 30px">  
	<form id="ff" method="post" action="DesignGraphDate.ashx" enctype="multipart/form-data" style="text-align: center">
	...
	<table id="Table1" style="width:100%;  margin-top :5px;" cellpadding="5" runat="server">
		...
		<tr>
            <td>初设计划时间</td>
			<td><input id="INITIALDESISUBMITDATE_P" name="INITIALDESISUBMITDATE_P" class="easyui-datebox"  data-options="formatter:myformatter,parser:myparser"/></td>
		    <td>蓝图计划存档时间</td>
            <td><input id="BLUEGRAPHDOCUMENT_P" name="BLUEGRAPHDOCUMENT_P" class="easyui-datebox"  data-options="formatter:myformatter,parser:myparser"/></td>
