<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DesignFile.aspx.cs" Inherits="plan_planRun_bdtz_DesignFile" %>
...
<body>
<div id="p" class="easyui-panel" title="上传初设文档" style="width:100%;padding:10px;">
  <div style="padding:10px 40px 20px 40px">  
    <form id="ff" method="post" action="DesignFile.ashx" enctype="multipart/form-data">
   <input value="1" type="hidden" id="hd_id"  runat="server"/>
	<table id="Table1" class="dv-table" style="width:100%; margin-top :5px; text-align:center" cellpadding="5">
        ...
        <tr>
			<td>初设文档</td>
			<td><input type="file"  id="INITDESIGNFILE" name="INITDESIGNFILE" class="easyui-validatebox textbox" data-options="required:true"/></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
