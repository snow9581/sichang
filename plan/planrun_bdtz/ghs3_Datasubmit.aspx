<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ghs3_Datasubmit.aspx.cs" Inherits="plan_planRun_bdtz_ghs3_Datasubmit" %>
...
<body>
<div id="p" class="easyui-panel" title="上传产能设计条件表" style="width:100%;padding:10px;">
  <div style="padding:10px 40px 20px 40px">  
    <form id="ff" method="post" action="ghs3_Datasubmit.ashx" enctype="multipart/form-data">
   <input value="1" type="hidden" id="hd_id"  runat="server"/>
	<table id="Table1" class="dv-table" style="width:100%; margin-top :5px; text-align:center" cellpadding="5">
		...
		<tr>
			...
			<td>产能设计条件表</td>
			<td><input type="file"  id="PLANRUNTABLE" name="PLANRUNTABLE" class="easyui-validatebox textbox" runat="server" data-options="required:true"/></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
