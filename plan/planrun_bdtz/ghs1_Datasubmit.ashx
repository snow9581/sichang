...
public class datasubmit : BaseHandler
{
    ...
    public override void AjaxProcess(HttpContext context)
    {
       ...
       // string EstiInvestment = context.Request.Params["EstiInvestment"];
        ...
        DB db = new DB();
        string sql = "update T_PLANRUN_BDTZ  set  DRAFTSOLUTIONFILE='" + fileWORDName + "' ,SOLUCOMPDATE_R = to_date('" + DateTime.Now.ToString() + "','yyyy-mm-dd hh24:mi:ss') where PID=" + id;
