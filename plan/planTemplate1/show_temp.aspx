    ...
    <table id="dg">
        <thead>
            <tr>
				...
				<th field="TEMPNAME" sortable="true" data-options="width:170">模板名称</th>
                <th field="WIRTESOLUCYCLE" sortable="true" data-options="width:170">编写方案周期</th>
				<th field="INSTCHECKSOLUCYCLE" sortable="true" data-options="width:170">所审方案周期</th>
				<th field="FACTCHECKSOLUCYCLE" sortable="true" data-options="width:170">厂审方案周期</th>											
			</tr>
        </thead>
    </table>
