...
<body>
	...
	<table class="dv-table" style="width:100%;background:#fafafa;padding:5px;margin-top:5px;">
		<tr>
            <td>模板名称</td>
			<td><input name="TEMPNAME" class="easyui-validatebox" size=5 value='0'/></td>
			<td>一次委托资料周期</td>
			<td><input name="MAJORDELEGATECYCLE" class="easyui-validatebox" size=5 value='0' /></td>
            <td>工程量提交周期</td>
			<td><input name="WORKLOADSUBMITCYCLE" class="easyui-validatebox" size=5 value='0'/></td>
			<td>施工白图校审周期</td>
			<td><input name="WHITEGRAPHPROOFCYCLE" class="easyui-validatebox" size=5 value='0'/></td>
			<td>蓝图存档周期</td>
			<td><input name="BLUEGRAPHSUBMITCYCLE" class="easyui-validatebox" size=5 value='0'/></td>		
		</tr>
        </table>
