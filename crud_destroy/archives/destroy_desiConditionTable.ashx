...
<%@ WebHandler Language="C#" Class="destroy_desiConditionTable" %>
///<summary> 
...
public class destroy_desiConditionTable : BaseHandler
{
    ...
    public override void AjaxProcess(HttpContext context)
    {
        ...
        string sql = "delete from T_DESICONDITIONTABLE where ID='" + T.preHandleSql(ID) + "'";
