...
<%@ WebHandler Language="C#" Class="destroy_construction" %>
///<summary> 
...
public class destroy_construction : BaseHandler
{
    public override void AjaxProcess(HttpContext context)
    {
        ...
        string sql = "delete from T_construction where ID='" + T.preHandleSql(ID) + "'";
