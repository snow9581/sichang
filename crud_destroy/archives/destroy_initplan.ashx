...
<%@ WebHandler Language="C#" Class="destroy_initplan" %>
///<summary> 
  ///模块编号：archives-01 电子档案管理子系统2号模块 destroy功能代码   
...
public class destroy_initplan : BaseHandler {
    ...
    public override void AjaxProcess(HttpContext context)
    {
        ...
        string sql = "delete from T_initplan where ID='" + T.preHandleSql(ID) + "'";
