<%@ WebHandler Language="C#" Class="update_plan" %>
...
public class update_plan : BaseHandler {
    ...
    public override void AjaxProcess(HttpContext context)
    {
        ...
        DB db = new DB();
        string filename = "";
        string idsql = "select FILES from T_PLAN where ID='" + T.preHandleSql(ID) + "'";
        ...
        string sql = "update T_PLAN set PID='" + T.preHandleSql(PID) + "',PNAME='" + T.preHandleSql(PNAME) + 
