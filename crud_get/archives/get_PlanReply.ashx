...
///<summary> 
///模块编号：archives-05 电子档案管理子系统5号模块 计划批复文档表 GET功能代码   
...
public class get_event : BaseHandler {
    ...
    public override void AjaxProcess(HttpContext context)
    {
        ...
        string sqlstr = "select * from(select t.*,rownum rn from(select * from T_PlanReply " + QSentence + ") t where rownum<=" + page * rows + ") where rn>" + (page - 1) * rows + "";

        ///条件查询 end
        string sql = "select count(*) from T_planReply" + QSentence;
